...
public class ForceCurrentFactionCommand extends CommandBase {
    ...
    public String getName() {
        return "force-current-faction";
    }

    @Override
    public String getUsage(ICommandSender sender) {
        return "force-current-faction <set, get, list-members, list-officers, association, set-status, give-ownership>";
    }
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        if ("set".equals(args[0])) {
            if (args.length < 3) {
                throw new CommandException("Not Enough Arguments: /force-current-faction set <name, color>");
            }
            ...
            if ("color".equals(args[1])) {
                if (args.length < 5) {
                    throw new CommandException("Not Enough Arguments: /force-current-faction set color <red> <green> <blue>");
                }
        ...
        if ("get".equals(args[0])) {
            if (args.length < 2) {
                throw new CommandException("Not Enough Arguments: /force-current-faction get <uuid, name, color>");
            }
        ...
        if ("give-ownership".equals(args[0])) {
            if (args.length < 2) {
                throw new CommandException("Not Enough Arguments: /force-current-faction give-ownership <player-name, player-uuid>");
            }
        ...
        if ("association".equals(args[0])) {
            if (args.length < 2) {
                throw new CommandException("Not Enough Arguments: /force-current-faction association <player-name, player-uuid>");
            }
        ...
        if ("set-status".equals(args[0])) {
            if (args.length < 3) {
                throw new CommandException("Not Enough Arguments: /force-current-faction set-status <player-name, player-uuid> <none, member, officer>");
            }
        ...
        if ("add-ally".equals(args[0])) {
            if (args.length < 2) {
                throw new CommandException("Not Enough Arguments: /force-current-faction add-ally <faction-name>");
            }
        ...
        if ("remove-ally".equals(args[0])) {
            if (args.length < 2) {
                throw new CommandException("Not Enough Arguments: /force-current-faction remove-ally <faction-name>");
            }
